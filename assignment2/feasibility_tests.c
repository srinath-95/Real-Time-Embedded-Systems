...
// U=1.0
U32_T ex6_period[] = {6, 8, 12, 24};
U32_T ex6_wcet[] = {1, 2, 4, 6};
...
{ 
    ...
    printf("Ex-6 U=%4.2f (C1=1, C2=2, C3=4, C4=6; T1=6, T2=8, T3=12, T4=24; T=D): ",
	...
	printf("Ex-8 U=%4.2f (C1=1, C2=2, C3=1; T1=2, T2=5, T3=10; T=D): ",
...
/* Completion time feasibility Test Function*/
...
/* Scheduling Point Feasibility Function*/
